...
class ZprimeBDTTree : public ModuleBASE {

public:
  explicit ZprimeBDTTree(uhh2::Context&);
...
void ZprimeBDTTree::book_histograms(uhh2::Context& ctx, vector<string> tags){
...
void ZprimeBDTTree::fill_histograms(uhh2::Event& event, string tag){
  string mytag = tag + "_Skimming";
  mytag = tag+"_General";
...
ZprimeBDTTree::ZprimeBDTTree(uhh2::Context& ctx){
  //  debug = true;
  debug = false;
...
bool ZprimeBDTTree::process(uhh2::Event& event){
 ...
 // }
  ...
  //BDT                                                                                                                             
  //  std::cout<<event.jets->size()<<std::endl;                                                                                     
...
UHH2_REGISTER_ANALYSIS_MODULE(ZprimeBDTTree)
